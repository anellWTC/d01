...
#    Updated: 2020/07/08 12:40:43 by anell            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
# The -Q i searched for using man ldapwhoami and it says Enable SASL Quiet mode. This hides all the lines starting with SASl
